...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pauseButton.setObjectName("shuffleButton")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "MP3 NGOCHIENVI"))
        self.currentTimeLabel.setText(_translate("MainWindow", "0:00"))
        self.totalTimeLabel.setText(_translate("MainWindow", "0:00"))
        self.menuFIle.setTitle(_translate("MainWindow", "Change folder"))
        self.open_file_action.setText(_translate("MainWindow", "Change root folder..."))
